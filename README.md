...
### Деньги
* С собой берем деньги только на первое время и на съем жилья. Перевести деньги из России сейчас невозможно. 
...
3. Находим семейного врача (huisarts). Врач ищется:
...
если нужно, подключаем подписку на [поездки в выходные](https://www.ns.nl/en/nsflex/webshop#/bestelling/producten).
