...
5. Делаем европейскую вакцину от коронавируса. Необходима для получения QR кода. [Здесь](https://www.ggd.amsterdam.nl/coronavirus/coronavaccinatie-locaties-amsterdam/) можно делать без предварительной записи. ВАЖНО! Если вы делали вакцинацию в России - не говорите об этом. **Доступные вакцины:**
...
Когда квартира найдена, переходим к пункту [Заселение в квартиру](#заселение-в-квартиру).
