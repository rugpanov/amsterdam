...
4. Для получения QR кода в Амстердаме можно сдать бесплатные тест на коронавирус. [Запись](https://afspraak.testenvoortoegang.org/evenement/type). Результат через 30 минут, для регистрации нужен местный номер. Код действует одни сутки. 
...
Когда квартира найдена, переходим к пунку [Заселение в квартиру](#Заселение_в_квартиру).
